...
class MinesweeperAI():
    ...
    def derive_new_sentences(self, ns):
        if ns.count == 0:
            ...
            for sentence in self.knowledge:
                if ns.cells.issubset(sentence.cells) and len(sentence.cells) > 0 and sentence.cells != ns.cells:
                    print("sentence cells",sentence.cells)
                    ...
                    self.derive_new_sentences(ns1)
                elif sentence.cells.issubset(ns.cells) and len(ns.cells) > 0 and sentence.cells != ns.cells:
                    print("sentence cells",sentence.cells)
